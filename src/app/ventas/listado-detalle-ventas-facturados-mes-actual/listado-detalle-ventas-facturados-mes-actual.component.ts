...
@Component({
  selector: 'app-listado-detalle-ventas-facturados-mes-actual',
  imports: [CommonModule, NgxDatatableModule, RouterLink],
  templateUrl: './listado-detalle-ventas-facturados-mes-actual.component.html',
  styleUrl: './listado-detalle-ventas-facturados-mes-actual.component.scss'
})
export class ListadoDetalleVentasFacturadosMesActualComponent implements OnInit {
