...
@Component({
  selector: 'app-listado-detalle-ventas-dia-en-curso',
  imports: [CommonModule, NgxDatatableModule, RouterLink],
  templateUrl: './listado-detalle-ventas-dia-en-curso.component.html',
  styleUrl: './listado-detalle-ventas-dia-en-curso.component.scss'
})
export class ListadoDetalleVentasDiaEnCursoComponent implements OnInit {
